resource "aws_dynamodb_table" "this" {
  ...
  tags             = merge(local.rendered_tags, { "info_name" = join("-", [var.project_name, "DYNAMODB"]) }, )
...
module "mandatory_tags" {
  source = "git::https://gitlab.com/telecom-argentina/devops/iac/terraform/modules/aws/aws-mandatory-tags.git?ref=v1.1.1"
